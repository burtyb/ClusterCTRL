...
/* These have been moved into usbconfighw.h in build directory */
 ...
 */
#define USB_CFG_DEVICE_NAME             'C', 'l', 'u', 's', 't', 'e', 'r', ' ', 'C', 'T', 'R', 'L'
